...
/**
 * Created with IntelliJ IDEA. User: Kocsen Date: 3/26/13 Time: 10:32 AM Dialog
 * to be shown when the user wants to input the default tab width for the
 * editor
 */
public class TabWidthDialog extends JDialog{
	...
	private void initComponents(){
		...
		URL url2 =
				getClass().getResource("/stock_table_fixed_proportional.png");
